...
const std::string &LabelMarkersOutputFile0 =
    Path + std::string("Lena_LabelMarkersUF_8Way_512x512_32u.raw");
const std::string &LabelMarkersOutputFile1 =
    Path + std::string("CT_skull_LabelMarkersUF_8Way_512x512_32u.raw");
const std::string &LabelMarkersOutputFile2 =
    Path + std::string("PCB_METAL_LabelMarkersUF_8Way_509x335_32u.raw");
const std::string &LabelMarkersOutputFile3 =
    Path + std::string("PCB2_LabelMarkersUF_8Way_1024x683_32u.raw");
const std::string &LabelMarkersOutputFile4 =
    Path + std::string("PCB_LabelMarkersUF_8Way_1280x720_32u.raw");

const std::string &CompressedMarkerLabelsOutputFile0 =
    Path + std::string("Lena_CompressedMarkerLabelsUF_8Way_512x512_32u.raw");
const std::string &CompressedMarkerLabelsOutputFile1 =
    Path +
    std::string("CT_skull_CompressedMarkerLabelsUF_8Way_512x512_32u.raw");
const std::string &CompressedMarkerLabelsOutputFile2 =
    Path +
    std::string("PCB_METAL_CompressedMarkerLabelsUF_8Way_509x335_32u.raw");
const std::string &CompressedMarkerLabelsOutputFile3 =
    Path + std::string("PCB2_CompressedMarkerLabelsUF_8Way_1024x683_32u.raw");
const std::string &CompressedMarkerLabelsOutputFile4 =
    Path + std::string("PCB_CompressedMarkerLabelsUF_8Way_1280x720_32u.raw");

const std::string &LabelMarkersBatchOutputFile0 =
    Path + std::string("Lena_LabelMarkersUFBatch_8Way_512x512_32u.raw");
const std::string &LabelMarkersBatchOutputFile1 =
    Path + std::string("CT_skull_LabelMarkersUFBatch_8Way_512x512_32u.raw");
const std::string &LabelMarkersBatchOutputFile2 =
    Path + std::string("PCB_METAL_LabelMarkersUFBatch_8Way_509x335_32u.raw");
const std::string &LabelMarkersBatchOutputFile3 =
    Path + std::string("PCB2_LabelMarkersUFBatch_8Way_1024x683_32u.raw");
const std::string &LabelMarkersBatchOutputFile4 =
    Path + std::string("PCB_LabelMarkersUFBatch_8Way_1280x720_32u.raw");

#ifdef CUDA11U1
const std::string &CompressedMarkerLabelsBatchOutputFile0 =
    Path +
    std::string("Lena_CompressedMarkerLabelsUFBatch_8Way_512x512_32u.raw");
const std::string &CompressedMarkerLabelsBatchOutputFile1 =
    Path +
    std::string("CT_skull_CompressedMarkerLabelsUFBatch_8Way_512x512_32u.raw");
const std::string &CompressedMarkerLabelsBatchOutputFile2 =
    Path +
    std::string("PCB_METAL_CompressedMarkerLabelsUFBatch_8Way_509x335_32u.raw");
const std::string &CompressedMarkerLabelsBatchOutputFile3 =
    Path +
    std::string("PCB2_CompressedMarkerLabelsUFBatch_8Way_1024x683_32u.raw");
const std::string &CompressedMarkerLabelsBatchOutputFile4 =
    Path +
    std::string("PCB_CompressedMarkerLabelsUFBatch_8Way_1280x720_32u.raw");
#endif
...
int main(int argc, const char *argv[]) {
  ...
  for (int nImage = 0; nImage < params.numofbatch; nImage++) {
    ...
    cudaError = cudaMalloc((void **)&pUFLabelDev[nImage],
    ...
    if (loadRaw8BitImage(pInputImageHost[nImage],
      ...
      if (nImage == 0)
        printf("Lena_CompressedMarkerLabelsUF_8Way_512x512_32u succeeded, "
               "compressed label count is %d.\n",
               nCompressedLabelCount);
      else if (nImage == 1)
        printf("CT_Skull_CompressedMarkerLabelsUF_8Way_512x512_32u succeeded, "
               "compressed label count is %d.\n",
               nCompressedLabelCount);
      else if (nImage == 2)
        printf("PCB_METAL_CompressedMarkerLabelsUF_8Way_509x335_32u succeeded, "
               "compressed label count is %d.\n",
               nCompressedLabelCount);
      else if (nImage == 3)
        printf("PCB2_CompressedMarkerLabelsUF_8Way_1024x683_32u succeeded, "
               "compressed label count is %d.\n",
               nCompressedLabelCount);
      else if (nImage == 4)
        printf("PCB_CompressedMarkerLabelsUF_8Way_1280x720_32u succeeded, "
               "compressed label count is %d.\n",
               nCompressedLabelCount);
    }
  }
  ...
  for (int nImage = 0; nImage < NUMBER_OF_IMAGES; nImage++) {
    if (nImage == 0)
      printf("Lena_CompressedMarkerLabelsUFBatch_8Way_512x512_32u succeeded, "
             "compressed label count is %d.\n",
             pUFBatchPerImageCompressedCountListHost[nImage]);
    else if (nImage == 1)
      printf("CT_Skull_CompressedMarkerLabelsUFBatch_8Way_512x512_32u "
             "succeeded, compressed label count is %d.\n",
             pUFBatchPerImageCompressedCountListHost[nImage]);
    else if (nImage == 2)
      printf("PCB_METAL_CompressedMarkerLabelsUFBatch_8Way_509x335_32u "
             "succeeded, compressed label count is %d.\n",
             pUFBatchPerImageCompressedCountListHost[nImage]);
    else if (nImage == 3)
      printf("PCB2_CompressedMarkerLabelsUFBatch_8Way_1024x683_32u succeeded, "
             "compressed label count is %d.\n",
             pUFBatchPerImageCompressedCountListHost[nImage]);
    else if (nImage == 4)
      printf("PCB_CompressedMarkerLabelsUFBatch_8Way_1280x720_32u succeeded, "
             "compressed label count is %d.\n",
             pUFBatchPerImageCompressedCountListHost[nImage]);
  }
